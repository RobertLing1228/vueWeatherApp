    ...
    >
      <RouterLink :to="{ name: 'home' }">
        <div class="flex items-center flex-1 gap-3">
          ...
          <span class="text-2xl">The Local Weather</span>
        </div>
      </RouterLink>
      ...
      <div class="flex justify-end flex-1 gap-3">
        <i
          @click="toggleModel"
          class="text-2xl duration-150 cursor-pointer fa-solid fa-circle-info hover:text-weather-secondary"
        ></i>
        <i
          class="text-2xl duration-150 cursor-pointer fa-solid fa-plus hover:text-weather-secondary"
        ></i>
      </div>
      <BaseModal :modalActive="modelActive" @handleModel="toggleModel">
