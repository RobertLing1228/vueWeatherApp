  ...
  <div class="flex flex-col items-center flex-1">
    ...
    <div class="flex flex-col items-center py-12 text-white">
      ...
      <p class="mb-8 text-8xl">
        {{ toDegree(weatherData.current.temp) }}&deg;C
      </p>
      <p>
        Feels like
        {{ toDegree(weatherData.current.feels_like) }} &deg;C
      </p>
      <p class="capitalize">
        ...
        <div class="flex gap-10 overflow-x-scroll">
          ...
          >
            ...
            <img
              ...
              alt=""
            />
            <p class="text-xl">{{ toDegree(hourData.temp) }}&deg;C</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="mx-8 text-white">
        ...
        >
          ...
          <div class="flex justify-end flex-1 gap-2">
            <p>H: {{ toDegree(day.temp.max) }}&deg;C</p>
            <p>L: {{ toDegree(day.temp.min) }}&deg;C</p>
          </div>
        </div>
      </div>
    </div>
